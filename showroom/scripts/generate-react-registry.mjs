...
const OUTPUT_FILE = path.join(ROOT, "static", "showroom", "showroomReact.registry.generated.js");
...
function main() {
  ...
  const lines = [];
  lines.push("// Auto-generated by showroom/scripts/generate-react-registry.mjs");
  ...
  lines.push("");
  lines.push("export const showroomReactRegistry = {");
